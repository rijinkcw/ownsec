...
sudo cp $SETTINGSCRIPTS/$SHfiles $BINDIR/$SHfiles 
done
...
do
sudo rm -f $BINDIR/$SHfiles
sudo cp $SETTINGSCRIPTS/0.LAMP/$SHfiles $BINDIR/$SHfiles 
done
...
do
sudo rm -f $BINDIR/$SHfiles
sudo cp $SETTINGSCRIPTS/0.LAPP/$SHfiles $BINDIR/$SHfiles 
done
...
do
sudo rm -f $BINDIR/$SHfiles
sudo cp $SETTINGSCRIPTS/1.APACHE2/$SHfiles $BINDIR/$SHfiles
done
...
do
sudo rm -f $BINDIR/$SHfiles
sudo cp $SETTINGSCRIPTS/1.LIGHTTPD/$SHfiles $BINDIR/$SHfiles
done
...
do
sudo rm -f $BINDIR/$SHfiles
sudo cp $SETTINGSCRIPTS/1.NGINX/$SHfiles $BINDIR/$SHfiles
done
...
do
sudo rm -f $BINDIR/$SHfiles
sudo cp $SETTINGSCRIPTS/2.MYSQL/$SHfiles $BINDIR/$SHfiles
done
...
do
sudo rm -f $BINDIR/$SHfiles
sudo cp $SETTINGSCRIPTS/2.PSQL/$SHfiles $BINDIR/$SHfiles
done
...
do
sudo rm -f $BINDIR/$SHfiles
sudo cp $SETTINGSCRIPTS/2.REDIS/$SHfiles $BINDIR/$SHfiles
done
...
do
sudo rm -f $BINDIR/$SHfiles
sudo cp $SETTINGSCRIPTS/3.PHP/$SHfiles $BINDIR/$SHfiles
done
...
do
sudo rm -f $BINDIR/$SHfiles
sudo cp $SETTINGSCRIPTS/3.DNS/$SHfiles $BINDIR/$SHfiles
done
...
do
sudo rm -f $BINDIR/$SHfiles
sudo cp $SETTINGSCRIPTS/4.TOR/$SHfiles $BINDIR/$SHfiles
done
...
do
sudo rm -f $BINDIR/$SHfiles
sudo cp $SETTINGSCRIPTS/5.Conky/$SHfiles $BINDIR/$SHfiles
done
...
do
sudo rm -f $BINDIR/$SHfiles
sudo cp $SETTINGSCRIPTS/6.Docker/$SHfiles $BINDIR/$SHfiles
done
...
do
sudo rm -f $BINDIR/$SHfiles
sudo cp $SETTINGSCRIPTS/7.Print-Scan/$SHfiles $BINDIR/$SHfiles
done
...
do
sudo rm -f $BINDIR/$SHfiles
sudo cp $SETTINGSCRIPTS/8.Bluetooth/$SHfiles $BINDIR/$SHfiles
done
...
do
sudo rm -f $BINDIR/$SHfiles
sudo cp $SETTINGSCRIPTS/9.GPS/$SHfiles $BINDIR/$SHfiles
done

echo "# Symlink script to copy and reload xfce configs"
sudo rm -f $BINDIR/SCRIPT_copy-XFCE-conf
sudo cp /opt/ownsec/0.Initial/settings-scripts/this-repo/SCRIPT_copy-XFCE-conf.sh $BINDIR/SCRIPT_copy-XFCE-conf
...
sudo cp /opt/ownsec/00.Maintain/updateallthegits.sh $BINDIR/updateallthegits.sh
cd /opt/ownsec/00.Maintain
sudo cp /opt/ownsec/00.Maintain/upgrade-os.sh $BINDIR/upgrade-os.sh
...
echo "# Finish Services Symlink Setup :)"
sudo updatedb
sudo ldconfig